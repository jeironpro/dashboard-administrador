        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="hidden lg:table-cell">Entidad</TableHead>
        ...
        <TableBody>
          {data.failedLogins.map((attempt) => (
            <TableRow key={attempt.id}>
              ...
              <TableCell>
                <span className="mono-label text-muted-foreground">{attempt.ip}</span>
              </TableCell>
              <TableCell className="hidden md:table-cell">
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Quién hizo qué y cuándo, errores del sistema e intentos de acceso fallidos.
        </p>
      </header>
      ...
      <Tabs defaultValue="auditoria">
        <TabsList className="flex-wrap">
          ...
          <TabsTrigger value="accesos">
            <ShieldAlert className="h-4 w-4" aria-hidden="true" /> Accesos fallidos
          </TabsTrigger>
        </TabsList>
